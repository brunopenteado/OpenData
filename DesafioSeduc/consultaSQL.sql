select 
	...
	------ Desempenho IDESP -------
	, I.anos_iniciais as IDESP_AI_18, I.anos_finais AS IDESP_AF_18, I.ensino_medio AS IDESP_EM_18
	------ SARESP  -------
	...
	, count(DIR.cd_escola) num_diretores_2014a2019
	, case TD.TX_RESP_Q001 when 'A' then 'Masculino' else 'Feminino' end as sexo_diretor
	, case VWD.[TX_RESP_Q002] when 'A' then 'Ate24' when 'B' then 'De25a29' when 'C' then 'De30a29' when 'D' then 'De40a49' when 'E' then 'De50a54' when 'F' then '55mais' end as faixa_etaria
	...
	, VWD.[TX_RESP_Q026], VWD.[TX_RESP_Q027], VWD.[TX_RESP_Q028], VWD.[TX_RESP_Q032], VWD.[TX_RESP_Q037]
